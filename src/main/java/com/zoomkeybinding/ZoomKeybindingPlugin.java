...
public class ZoomKeybindingPlugin extends Plugin
{
	@Inject
	...
	{
		log.info("ZoomKeybinding started!");
	}

	@Override
	protected void shutDown() throws Exception
	{
		log.info("ZoomKeybinding stopped!");
	}
	...
	public void onGameStateChanged(GameStateChanged gameStateChanged)
	{
		...
		{
			client.addChatMessage(ChatMessageType.GAMEMESSAGE, "", "ZoomKeybinding says " + config.greeting(), null);
		}
	}
